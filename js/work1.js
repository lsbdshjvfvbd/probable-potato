...
const zpimgs =[
    {url:'../img/大角鹿证书.jpg',title:'行业翘楚'},
    {url:'../img/大角鹿证书2.jpg',title:'广州名牌'},
    {url:'../img/大角鹿证书3.jpg',title:'最佳产品'},
    {url:'../img/大角鹿证书.jpg',title:'品牌保证'},
]
let arr = ''
// 获取作品介绍
zpimgs.forEach(item =>{
